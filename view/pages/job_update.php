...
$query = 'SELECT * FROM ilanlar WHERE ilan_id = :id';
...
$ilan_konum=$ilan['konum'];

$sql = "SELECT konum FROM ilan_konumlari WHERE ilan_id = :ilan_id";
...
?>
<script src="https://cdn.tiny.cloud/1/7sxvpp7q7qhs3o9f1k1v17aruw3tuelrbd3w04ee91p8zjeo/tinymce/7/tinymce.min.js" referrerpolicy="origin"></script>
...
<body>
    ...
    <div class="container">
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <input type="text" id="ilan_basligi" name="ilan_basligi" class="input-field" value="<?php echo htmlspecialchars($ilan['ilan_baslik']); ?>"><br>
            <label for="ilan_icerik">İlan İçeriği:</label><br>
            <textarea id="ilan_icerik" name="ilan_icerik" class="input-field"><?php echo htmlspecialchars($ilan['ilan_aciklama']); ?></textarea><br>
            <!-- Dosya Yükleme Alanı -->
            <label for="ilan_gorseli">İlan Görseli:</label><br>
            <input type="file" id="ilan_gorseli" name="ilan_gorseli" class="input-field" onchange="previewFile()"><br>
            <?php if ($ilan['ilan_gorseli']) : ?>
                <img id="currentFile" src="<?php echo htmlspecialchars($ilan['ilan_gorseli']); ?>" alt="Mevcut Dosya" style="max-width: 200px; max-height: 200px;"><br>
            <?php endif; ?>
            <div class="d-flex row align-items-start">  
                ...
                <div class="search-frame col-lg-6">
                    ...
                    <!-- Formun içine aşağıdaki gizli inputu ekleyin -->
    ...
    <script>
        ...
        function updateSelectedItems(value) {
            ...
            // Seçilen konumların olduğu div içinde bu konum zaten var mı kontrol eder
            ...
            for (let i = 0; i < existingItems.length; i++) {
                if (existingItems[i].getAttribute('data-value') === value) {
                    return; // Bu konum zaten seçilmişse eklemeyi durdur
                }
            }
...
ü            });
        ...
        $(document).ready(function() {
            var ilanKonum = "<?php echo $ilan_konum; ?>";
            ...
            $(".js-example-basic-single").val(ilanKonum).trigger("change");
        });
        $(".js-example-basic-single").val(null).trigger('change');
        $(".js-example-basic-multiple").val(null).trigger('change');

        function previewFile() {
            const preview = document.getElementById('currentFile');
            const file = document.getElementById('ilan_gorseli').files[0];

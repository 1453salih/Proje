...
<body>
    ...
    <div class="main_body container  mt-5  ">
        ...
        <div class="content_left col-lg-6 ">
                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <p class="card-text">Kayıt olarak iş ilanlarını keşfedin ve hayalinizdeki kariyere bir adım daha yaklaşın!</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card my-3" style="max-width: 650px;">
                <div class="row g-0">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            <h5 class="card-title">CV'ni Yükle</h5>
                            <p class="card-text">CV'ni yükleyerek hayalinizdeki işe bir adım daha yaklaşın ve kariyer fırsatlarınıza hızla erişin!</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card my-3" style="max-width: 650px;">
                <div class="row g-0">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            <h5 class="card-title">Sana Uygun İşini Bul</h5>
                            <p class="card-text">Sana uygun işini bul, hayallerindeki kariyere hızla adım at ve geleceğini şekillendir!</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-6 col-md-12 col-xs-12 col-sm-12 register_form mb-5">
            <div class="row text-start mb-5 mt-3">
                <h1 class="form_title">İş Arayan Kayıt</h1>
            </div>
            <div class="row">
                <form class="form-group" method="POST">
                    ...
                    <div class="row">
                        <input type="password" name="password_confirm" id="password_confirm" class="form__input form-control" placeholder="Şifreni Doğrula"required>
                    </div>

                    <div class="checkbox d-flex flex-row mb-3">
                        <input type="checkbox" name="sozlesme" id="sozlesme" class="form__check me-2 " required>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($password !== $password_confirm) {
            echo "<div id='error-alert' class='alert alert-danger alert-dismissible fade show fixed-top mt-4 ms-4 me-4' role='alert'>Şifreler eşleşmiyor!

                ...
                <div class="col-lg-6 col-md-12 col-xs-12 col-sm-12 login_form d-flex align-items-center">
                    <div class="container-fluid">
                        <div class="row text-start mb-3 mt-5">
                            <h1 class="form_title">İş Arayan Üye Girişi</h1>
                        </div>
                        <div class="row">
                            <?php
                            ...
                            <form method="POST" class="form-group">
                                <div class="row">
                                    <input type="text" name="username" id="username" class="form__input" placeholder="Kullanıcı Adı" value="<?php echo $username; ?>">
                                </div>
                        ...
                        <div class="row form_soru text-center">
                            <p>Üye değil misin ? <a href="./register.php"> Üye Ol.</a></p>
                        </div>
                    </div>
                </div>
            </div>
